...
import {AccessParam, IamService} from "@microend/iam";
...
const accessList: AccessParam[] = [{
    name: 'Module One Read Data',
    description: '',
    id: 'module-one-do-sedap'
}, {name: 'Module One Read Data', description: '', id: 'module-two-sedap'}];
